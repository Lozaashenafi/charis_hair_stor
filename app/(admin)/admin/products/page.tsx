    ...
    <div className="space-y-10 pb-20 px-4 md:px-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pt-6">
        ...
        <Link 
          ...
          className="w-full md:w-auto bg-[#3d342a] text-[#d4a574] px-10 py-5 rounded-full text-[11px] font-bold uppercase tracking-widest hover:bg-[#2d2520] hover:scale-105 transition-all text-center shadow-xl flex items-center justify-center gap-3"
        >
